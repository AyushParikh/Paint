...
public class PaintSaveFileParserTest {
	...
	public void parserTest17() throws IOException {
		this.doParserTestCase("samplefiles/rectangle_fail_wrongend.txt",
				"Returns false for rectangle with a wrong ending", "Error in line 7 ");
	}
	
	@Test
	public void parserTest18() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_fail_wrongend.txt",
				"Returns false for squiggle with a wrong ending", "Error in line 9 ");
	}
	
	@Test
	public void parserTest19() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_fail_wrongorder.txt",
				"Returns false for squiggle with a wrong order", "Error in line 3 ");
	}
	
	@Test
	public void parserTest20() throws IOException {
		this.doParserTestCase("samplefiles/rectangle_fail_wrongorder.txt",
				"Returns false for rectangle with a wrong order", "Error in line 4 ");
	}
